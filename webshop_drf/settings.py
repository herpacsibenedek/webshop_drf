"""
Django settings for webshop_drf project.
...
SECRET_KEY = 'v7cqgbd5e1hg)0)2l$^*w9jcdl5czx=-uq8k@r*!5)6y*@7%t7'
...
WSGI_APPLICATION = 'webshop_drf.wsgi.application'
